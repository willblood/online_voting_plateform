      ...
      <main style={{ marginLeft: "256px", padding: "2rem", minHeight: "100vh", position: "relative" }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            <button
              style={{ display: "flex", alignItems: "center", gap: "8px", padding: "12px 24px", background: "#ffffff", border: "1px solid rgba(222,193,175,0.4)", borderRadius: "9999px", color: "#954a00", fontFamily: "Manrope, sans-serif", fontWeight: 700, cursor: "pointer", fontSize: "0.875rem", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", transition: "transform 0.15s" }}
            ...
            <Link
              to="/admin/elections"
              style={{ display: "flex", alignItems: "center", gap: "8px", padding: "12px 32px", background: "#f77f00", border: "none", borderRadius: "9999px", color: "#ffffff", fontFamily: "Manrope, sans-serif", fontWeight: 700, cursor: "pointer", fontSize: "0.875rem", boxShadow: "0 8px 24px rgba(247,127,0,0.25)", transition: "transform 0.15s", textDecoration: "none" }}
              onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.transform = "translateY(-2px)")}
              onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.transform = "translateY(0)")}
            >
        ...
        <section style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "2rem", marginBottom: "2rem", position: "relative", zIndex: 10 }}>
          ...
          <div style={{ background: "#ffffff", borderRadius: "24px", padding: "2rem", boxShadow: "0 12px 32px rgba(10,22,40,0.06)", overflow: "hidden" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "2rem" }}>
              ...
              <span style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "6px 16px", borderRadius: "9999px", background: "#80fc98", color: "#007432", fontSize: "0.7rem", fontWeight: 700 }}>
                <span style={{ width: "8px", height: "8px", borderRadius: "50%", background: "#006e2e", display: "inline-block", animation: "pulse-dot 2s infinite" }} />
                EN DIRECT
              </span>
            </div>
            <div style={{ display: "flex", alignItems: "flex-end", gap: "3rem" }}>
              <div style={{ flex: 1 }}>
                ...
                <div style={{ width: "100%", height: "16px", background: "#ebe8e3", borderRadius: "9999px", overflow: "hidden" }}>
                  <div style={{ width: "74.8%", height: "100%", background: "linear-gradient(to right, #954a00, #f77f00)", borderRadius: "9999px" }} />
                </div>
          ...
          {/* Security card */}
          <div style={{ background: "#ffffff", borderRadius: "24px", padding: "2rem", boxShadow: "0 12px 32px rgba(10,22,40,0.06)", borderLeft: "8px solid #006e2e", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1.5rem", marginBottom: "12px" }}>
              <div style={{ width: "64px", height: "64px", background: "#80fc98", borderRadius: "16px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <span className="material-symbols-outlined" style={{ fontSize: "36px", color: "#007432" }}>verified_user</span>
              </div>
              <div>
                <p style={{ fontFamily: "Plus Jakarta Sans, sans-serif", fontSize: "2.5rem", fontWeight: 800, color: "#1c1c19", margin: 0, lineHeight: 1 }}>99.2%</p>
                <p style={{ color: "#535f74", fontSize: "0.875rem", fontWeight: 500, margin: "4px 0 0" }}>Bureaux Opérationnels</p>
              </div>
            </div>
        ...
        <section style={{ marginBottom: "2rem", position: "relative", zIndex: 10 }}>
          <div style={{ background: "#ffffff", borderRadius: "24px", padding: "1.5rem", boxShadow: "0 4px 16px rgba(10,22,40,0.04)", display: "flex", flexWrap: "wrap", alignItems: "center", gap: "1.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", paddingRight: "1.5rem", borderRight: "1px solid rgba(222,193,175,0.4)" }}>
            ...
            <div style={{ flex: 1, display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1rem" }}>
              {[
                { label: "Région", value: region, options: ["Toutes les régions", "Lagunes", "Haut-Sassandra", "Bas-Sassandra"], onChange: setRegion },
                { label: "Département", value: dept, options: ["Tous les départements", "Abidjan", "Yamoussoukro", "Bouaké"], onChange: setDept },
                { label: "Commune", value: commune, options: ["Toutes les communes", "Cocody", "Plateau", "Marcory"], onChange: setCommune },
                { label: "Niveau", value: "National", options: ["National", "International (Diaspora)"], onChange: () => {} },
              ].map((filter) => (
                <div key={filter.label} style={{ position: "relative" }}>
                  <label style={{ position: "absolute", top: "-9px", left: "12px", padding: "0 4px", background: "#ffffff", fontSize: "0.6rem", fontWeight: 700, color: "#535f74", letterSpacing: "0.08em", textTransform: "uppercase", zIndex: 1 }}>
                    {filter.label}
                  </label>
                  <select
                    value={filter.value}
                    onChange={(e) => filter.onChange(e.target.value)}
                    style={{ width: "100%", padding: "12px 36px 12px 16px", background: "#f6f3ee", border: "none", borderRadius: "12px", color: "#1c1c19", fontFamily: "Manrope, sans-serif", fontSize: "0.875rem", fontWeight: 600, cursor: "pointer", appearance: "none", outline: "none" }}
                  >
            ...
            <button style={{ padding: "12px 24px", background: "#1c1c19", border: "none", borderRadius: "12px", color: "#fcf9f4", fontFamily: "Manrope, sans-serif", fontWeight: 700, fontSize: "0.875rem", cursor: "pointer", transition: "background 0.15s" }}
        ...
        <section style={{ position: "relative", zIndex: 10 }}>
          <div style={{ background: "#ffffff", borderRadius: "24px", boxShadow: "0 12px 32px rgba(10,22,40,0.06)", overflow: "hidden" }}>
            <div style={{ padding: "2rem", borderBottom: "1px solid #ebe8e3", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <Link to="/admin/elections" style={{ padding: "4px 16px", borderRadius: "9999px", background: "#f77f00", color: "#ffffff", fontSize: "0.75rem", fontWeight: 700, textDecoration: "none" }}>
                Voir tout →
              </Link>
            </div>
    ...
    >
      <td style={{ padding: "1.25rem 2rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          <div style={{ width: "40px", height: "40px", borderRadius: "12px", background: election.iconBg, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            <span className="material-symbols-outlined" style={{ color: election.iconColor, fontSize: "20px" }}>{election.icon}</span>
          </div>
          <span style={{ fontWeight: 700, color: "#1c1c19" }}>{election.name}</span>
        </div>
      </td>
      <td style={{ padding: "1.25rem 2rem", fontSize: "0.875rem", fontWeight: 500, color: "#535f74" }}>{election.date}</td>
      <td style={{ padding: "1.25rem 2rem" }}>
        <span style={{ display: "inline-flex", alignItems: "center", padding: "4px 12px", borderRadius: "9999px", fontSize: "0.75rem", fontWeight: 700, background: election.statusBg, color: election.statusColor }}>
          {election.status}
        </span>
      </td>
      <td style={{ padding: "1.25rem 2rem", textAlign: "right" }}>
        <div style={{ display: "flex", justifyContent: "flex-end", gap: "8px", opacity: hovered ? 1 : 0, transition: "opacity 0.15s" }}>
          {election.actions.map((action) => (
            <button key={action} title={action} style={{ padding: "8px", background: "transparent", border: "none", borderRadius: "8px", cursor: "pointer", color: "#535f74", display: "flex", alignItems: "center", transition: "background 0.15s" }}
